...
export const addToPlaylist = (id) => async (dispatch) => {
    try {
        dispatch({ type: "allToPlaylistRequest" });
        ...
        // console.log(data);
        dispatch({ type: 'allToPlaylistSuccess', payload: data.message })
    }
    catch (error) {
        dispatch({ type: 'allToPlaylistFail', payload: error.response.data.message })
    }
